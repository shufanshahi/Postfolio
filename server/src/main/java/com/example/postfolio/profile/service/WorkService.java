...
public class WorkService {
    ...
    public WorkDto createWork(WorkDto workDto, User user) {
        ...
        Work work = Work.builder()
                ...
                .achievements(workDto.getAchievements())
                .technologiesUsed(workDto.getTechnologiesUsed())
                .profile(profile)
                .build();
    ...
    public WorkDto updateWork(Long workId, WorkDto workDto, User user) {
        ...
        work.setAchievements(workDto.getAchievements());
        work.setTechnologiesUsed(workDto.getTechnologiesUsed());
