...
export const POST_SERVICE_URL = process.env.NEXT_PUBLIC_POST_SERVICE_URL || 'http://localhost:8080';
export const JOB_SERVICE_URL = process.env.NEXT_PUBLIC_JOB_SERVICE_URL || 'http://localhost:8080';
