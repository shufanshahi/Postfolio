...
const subtleCard = 'bg-gradient-to-br from-teal-50/65 via-white/55 to-indigo-50/60 dark:from-slate-800/70 dark:via-slate-800/60 dark:to-slate-800/70 backdrop-blur-md border border-teal-900/5 dark:border-slate-700/60 hover:border-teal-500/30 dark:hover:border-teal-400/30 transition-colors';function RoadmapView() {
    const { user } = useAuth();
                              ...
                              <div className="flex flex-wrap gap-2">
                                {item.videoLinks.map((link, idx) => (
                                  <Button
                                    ...
                                    className="bg-red-50 border-red-200 text-red-700 hover:bg-red-100 dark:bg-red-900/20 dark:border-red-700/50 dark:text-red-300 dark:hover:bg-red-900/30"
                                  >
                              ...
                              <div className="flex flex-wrap gap-2">
                                {item.websiteLinks.map((link, idx) => (
                                  <Button
                                    ...
                                    className="bg-sky-50 border-sky-200 text-sky-700 hover:bg-sky-100 dark:bg-sky-900/20 dark:border-sky-700/50 dark:text-sky-300 dark:hover:bg-sky-900/30"
                                  >
                              ...
                              <div className="flex flex-wrap gap-2">
                                {item.resourceLinks.map((resource, idx) => (
                                  <Badge
                                    key={idx}
                                    variant="outline"
                                    className="bg-teal-50 border-teal-200 text-teal-700 dark:bg-teal-900/20 dark:border-teal-700/50 dark:text-teal-300"
                                  >
